...
# ============================================================
# SEND REQUEST -> OPEN USER'S EMAIL APP WITH PRE-FILLED EMAIL
# ============================================================
...
"""
    ...
    # Create a native email link.
    # Android will pass this to the email app installed on
    # the customer's phone, such as Gmail.
    mailto_link = (
    ...
    st.markdown(
        f"""
        <a href="{mailto_link}" class="send-btn">
            📦 Send Request
        </a>
        """,
        unsafe_allow_html=True
