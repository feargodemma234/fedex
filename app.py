...
BTC_QR_URL = "https://i.imgur.com/placeholder.png" # I will use the QR you uploaded
...
# ========== CHECKOUT ==========
    ...
    if st.session_state.pending_order:
        ...
        if order['method'] == "Bitcoin":
            ...
            st.image(1798422464664336) # YOUR BTC QR IMAGE
            st.markdown('</div>', unsafe_allow_html=True)

        st.subheader("2. Send Proof of Payment")
        st.write("After payment, click the button below. It will open your Gmail with everything filled. Just attach your proof screenshot and send.")
...
Thank you."""
        ...
        st.link_button("📧 Open Gmail to Send Proof", gmail_link, use_container_width=True)
