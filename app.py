...
.info-text { background: #1e293b; padding: 12px; border-radius: 8px; border-left: 3px solid #22c55e; font-size: 14px; }
</style>
...
# ========== CHECKOUT ==========
    ...
    if st.session_state.pending_order:
        ...
        <div class="info-text">
        <b>Important:</b><br>
        Once payment is made, attach proof of payment below.<br>
        • If Gift Card: Take a clear picture and attach it<br>
        • If Bank Transfer/Bitcoin: Send to the wallet address above or scan QR code, then attach proof<br>
