...
st.markdown("""
<style>
    .logo { font-size: 22px; font-weight: 800; color: #10B981; display: flex; align-items: center; gap: 8px; padding: 16px 20px; }
    ...
    .send-btn { background: #EF4444; color: white; padding: 14px 0; border-radius: 12px; font-size: 18px; font-weight: 700; width: 100%; text-align: center; display: block; text-decoration: none; border: none; }
    .send-btn-disabled { background: #333; color: #666; padding: 14px 0; border-radius: 12px; font-size: 18px; font-weight: 700; width: 100%; text-align: center; display: block; text-decoration: none; }
...
Thank you!"""
    ...
    # THIS IS THE KEY: A REAL LINK BUTTON
