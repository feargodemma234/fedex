...
if st.session_state.tab == "Foods":
    ...
    with col2:
        st.image("https://images.pexels.com/photos/825574/pexels-photo-825574.jpeg?auto=compress&cs=tinysrgb&w=400", use_container_width=True)
    ...
    col1, col2, col3 = st.columns(3)
    clothes = [
        ("Ankara Shirt", "Premium African print", "$45", "https://images.pexels.com/photos/1192609/pexels-photo-1192609.jpeg?auto=compress&cs=tinysrgb&w=400"),
