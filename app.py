...
ADMIN_EMAILS = st.secrets.get("ADMIN_EMAILS", ["admin@fedex.com"]) # Put your admin email here
SMTP_EMAIL = st.secrets["SMTP_EMAIL"]
SMTP_APP_PASSWORD = st.secrets["SMTP_APP_PASSWORD"]
STORE_EMAIL = st.secrets["STORE_EMAIL"]

# UNCOMMENT THIS WHEN YOU CONNECT SUPABASE
...
def load_products():
    ...
    return [
        {"id": 1, "name": "FedEx 10x13 Poly Mailer", "description": "Pack of 100", "price": 15.00, "image_url": "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=400"},
        {"id": 2, "name": "FedEx Shipping Labels", "description": "Roll of 500", "price": 25.00, "image_url": "https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=400"},
        {"id": 3, "name": "FedEx Thermal Printer", "description": "4x6 Label Printer", "price": 280.00, "image_url": "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400"},
        {"id": 4, "name": "FedEx Digital Scale", "description": "Up to 50lbs", "price": 95.00, "image_url": "https://images.unsplash.com/photo-1581091226825-a6a2a2aee158?w=400"},
        {"id": 5, "name": "FedEx Envelope", "description": "Legal size", "price": 10.00, "image_url": "https://images.unsplash.com/photo-1608198093002-ad4e005484ec?w=400"},
        {"id": 6, "name": "FedEx Tape", "description": "Pack of 6 rolls", "price": 18.00, "image_url": "https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=400"}
    ]
...
def auth_page():
    ...
    with tab1:
        ...
        if st.button("Login", use_container_width=True, key="login_btn"):
            ...
            st.session_state.user = type('obj', (object,), {'email': email}) # FAKE LOGIN FOR NOW
            st.rerun()
    with tab2:
...
if st.session_state.user is None:
    auth_page()
    st.stop() # IMPORTANT: stops code here
