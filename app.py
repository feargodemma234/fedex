...
def load_products():
    ...
    return [
        ...
        {"id": str(uuid.uuid4()), "name": "USB-C Charger", "description": "65W Fast Charging Adapter", "price": 19.99, "image_url": "https://images.unsplash.com/photo-1583863788434-a4a8dd7a5d0b?w=400"},
