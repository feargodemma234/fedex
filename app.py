...
<style>
    ...
    .top-bar {
        ...
        z-index: 999999; /* puts it above the crown */
        display: flex;
        align-items: center;
        padding: 0 20px;
    }
    ...
    .block-container {
        padding-top: 5rem !important; /* push content down so bar doesn't cover it */
    }
</style>
...
# ========== REST OF YOUR CODE ==========
# ... KEEP EVERYTHING ELSE THE SAME FROM "SESSION" DOWN ...
# SESSION
...
if st.session_state.page == "Store":
    st.title("") # REMOVED TITLE SO LOGO BAR SHOWS
    cols = st.columns(2)
