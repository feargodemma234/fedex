...
p, label {font-family: 'Inter', sans-serif; color: #DDDDDD;}
.hero {text-align: center; padding: 80px 20px;}
.hero h1 {font-size: 60px; letter-spacing: 3px;}
.hero h2 {font-size: 20px; color: #AAAAAA; font-weight: 300;}
.card {background: #1A1A1A; border-radius: 15px; padding: 15px; border: 1px solid #333;}
.stButton>button {background-color: #FFD700; color: black; font-weight: bold; border-radius: 8px; border: none; padding: 10px 25px; width: 100%;}
.orange-bar {background: #FF6A00; height: 4px; width: 60px; margin: 20px auto;}
.tab-btn {background: #1A1A1A; border: 1px solid #333; color: white;}
...
col3.metric("Made In", "Onitsha")

# STORY
st.markdown("<h2 style='text-align:center; margin-top: 80px;'>// 03. THE STORY</h2>", unsafe_allow_html=True)
st.write("Born in Onitsha. We feed you. We dress you. CLOSE brings the taste of home and the look of the streets to your life.")
