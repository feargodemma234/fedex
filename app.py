...
if all_filled:
    ...
    body = f"""Hi Quantum Industries Team,
...
"""
    ...
    gmail_link = f"intent://compose?to=quantumindustries258@gmail.com&subject={encoded_subject}&body={encoded_body}#Intent;scheme=mailto;package=com.google.android.gm;end"

    st.markdown(
        f'<a href="{gmail_link}" class="send-btn">📦 Send Request</a>',
        unsafe_allow_html=True
    )
...
st.markdown(
    '<div class="info-card"><b>1. Fill Form</b><br>'
    '<span style="color:#aaa">Tell us what you need and where to deliver</span></div>',
    unsafe_allow_html=True
)

st.markdown(
    '<div class="info-card"><b>2. We Confirm</b><br>'
    '<span style="color:#aaa">We’ll call you with price and delivery time</span></div>',
    unsafe_allow_html=True
)

st.markdown(
    '<div class="info-card"><b>3. Delivered</b><br>'
    '<span style="color:#aaa">Get it delivered straight to your door</span></div>',
    unsafe_allow_html=True
)